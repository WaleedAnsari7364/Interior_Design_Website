    ...
    return (
        <div className="container py-16">
            ...
            <div className="grid lg:grid-cols-2 place-items-center">
                <div>
                    <img src="/image/aboutfront.png" width={900} height={500} alt="" className="max-md:hidden" />
                </div>
                ...
                <div className="items-center">
                    ...
                    <div className="flex px-12 pt-4 gap-x-4">
                        <img src="/image/awards.png" width={100} height={80} alt="" className="h-[100px]" />
                        <img src="/image/awards1.png" width={100} height={80} alt="" className="h-[100px]" />
                    </div>
                </div>
            </div>
        </div>
