    ...
    const projects = [
        {
            ...
            description: 'Badroom with a clean and comfortable design for your family. charming with a modern design.',
            ...
            <div className="container grid grid-cols-2 gap-8 py-8">
                {projects.map((project) => (
                    <div key={project.id} className="relative overflow-hidden rounded-xl group">
                        <div>
                            <img src={project.image} width={480} height={380} alt="" className="w-full" />
                        </div>
